...
sed -i "s/clmvaldn/clmsum/" lapw5.def
...
lapw5 lapw5.def
./a.out
mv "$filename".rho_arrange "$filename".rho_arrange_001middle
...
lapw5 lapw5.def
./a.out
mv "$filename".rho_arrange "$filename".rho_arrange_110
...
lapw5 lapw5.def
./a.out
mv "$filename".rho_arrange "$filename".rho_arrange_1-10
...
lapw5 lapw5.def
./a.out
mv "$filename".rho_arrange "$filename".rho_arrange_100middle
...
lapw5 lapw5.def
./a.out
mv "$filename".rho_arrange "$filename".rho_arrange_010middle
