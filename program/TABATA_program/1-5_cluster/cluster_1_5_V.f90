...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 le(k)=0
        ...
        if(FreeEnergy(k)+47.07*(sin(theta)**2)<F_easy) then
           F_easy=FreeEnergy(k)+47.07*(sin(theta)**2)
           angle_easy=k
           end if
        ...
        if(m==3) then
        do i=0,180
     !      print*,(i-90)/180d0*pi,(FreeEnergy(i)+47.07*(sin((i-90)/180d0*pi)**2)-F_easy)*10d0/62d0,angle_easy,T
        end do
     end if
     ...
     print *,V,(k1+yk1)*10d0/62d0*1.017,real(Le(angle_easy)),-aimag(Ley(angle_easy)),real(Lex(angle_easy)) &
          ,real(Se(angle_easy)),-aimag(Sye(angle_easy)),real(Sxe(angle_easy)),N4f(angle_easy),angle_easy
  end do
