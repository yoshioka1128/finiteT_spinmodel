program test
  ...
  double complex :: Le(0:180),Se(0:180),sxe(0:180),lex(0:180),sye(0:180),ley(0:180) 
...
!        end if
        ...
        if(FreeEnergy(k)*0.1192+yk1*(sin(theta)**2)<F_easy) then
           F_easy=FreeEnergy(k)*0.1192+yk1*(sin(theta)**2)
           angle_easy=k
        end if
     ...
     print*,V,k1*0.1192+yk1,real(Le(angle_easy)),-aimag(Ley(angle_easy)),real(Lex(angle_easy)) &
