...
open(33,file="~/research/CFPs/Sm_lambda411K/cfpSmFe11Ti_i_fullexp_lambda411_opencoreXC.txt")
...
write(6,*) ratom,2
write(6,"(f10.5,A,f10.5,A)") Hex,"d0",rd,"d0" ! Hex
write(6,"(f10.5,A,f10.5,A,f10.5,A,i5)") rl(2),"d0",rl(4),"d0",rl(6),"d0",ncfp
do l=2,6,2
   write(6,*) Alm(l,0),l,0
   do m=1,l
      if(m.eq.1) then
