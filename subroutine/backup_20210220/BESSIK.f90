      ...
      INTEGER(4) :: MAXIT=10000
      REAL(8) :: ri,rip,rk,rkp,x,xnu,XMIN=2.0d0
      REAL(8) :: EPS=1.0d-10,FPMIN=1.0d-30,PI=dacos(-1.0d0)
!CU    USES beschb
      INTEGER(4) :: i,l,nl
      REAL(8) :: a,a1,b,c,d,del,del1,delh,dels,e,f,fact,fact2,ff,&
