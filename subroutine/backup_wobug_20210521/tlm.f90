...
coffmag(2,-2)=dsin(2.0d0*phi)*dsin(theta)**2
coffmag(4, 2)=dcos(2.0d0*phi)*dsin(theta)**2*(7.0d0*dcos(theta)**2-1.0d0)
coffmag(4,-2)=dsin(2.0d0*phi)*dsin(theta)**2*(7.0d0*dcos(theta)**2-1.0d0)
coffmag(6, 2)=dcos(2.0d0*phi)*dsin(theta)**2*(33.0d0*dcos(theta)**4-18.0d0*dcos(theta)**2+1.0d0)
coffmag(6,-2)=dsin(2.0d0*phi)*dsin(theta)**2*(33.0d0*dcos(theta)**4-18.0d0*dcos(theta)**2+1.0d0)
! m=4
coffmag(4, 4)=dcos(4.0d0*phi)*dsin(theta)**4
coffmag(4,-4)=dsin(4.0d0*phi)*dsin(theta)**4
coffmag(6, 4)=dcos(4.0d0*phi)*dsin(theta)**4*(11.0d0*dcos(theta)**2-1.0d0)
coffmag(6,-4)=dsin(4.0d0*phi)*dsin(theta)**4*(11.0d0*dcos(theta)**2-1.0d0)
! m=6
coffmag(6, 6)=dcos(6.0d0*phi)*dsin(theta)**6
coffmag(6,-6)=dsin(6.0d0*phi)*dsin(theta)**6
