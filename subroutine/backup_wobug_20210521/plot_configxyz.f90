...
write(time,'(I5)') itime
open(8,file="~/research/llg/movie_source/TDf"//trim(adjustl(time))//".txt") 
open(9,file="~/research/llg/movie_source/TDg"//trim(adjustl(time))//".txt") 
open(10,file="~/research/llg/movie_source/TDFe"//trim(adjustl(time))//".txt") 
