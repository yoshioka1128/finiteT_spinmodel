...
!   write(6,*) "CC check"
!   write(6,*) 1,36.0d0*CC(2,-1,1),9.0d0/2.0d0*J1*(2.0d0*J1-1.0d0)**2
!   write(6,*) 2,9.0d0/8.0d0*CC(2,-2,1),J1*(2.0d0*J1-1.0d0)
else
   part=0.0d0
   CC=0.0d0
...
!                  if(ir.eq.1) write(6,*) "eng",JM(ii,2),im,JM(ii-im,2),def**2*(eigen(ii-im,ir)-eigen(ii,ir))
               end if
            end do ! do ii, M
...
!   write(6,*) "CC check finite-T"
!   write(6,*) 1,CC(2,-1,1),1.0d0/8.0d0*J1*(2.0d0*J1-1.0d0)**2
!   write(6,*) 2,CC(2,-2,1),J1*(2.0d0*J1-1.0d0)
!   write(6,*) JM(1,2),JM(nJ1,2)
!   write(6,*) eigen(1,1),eigen(nJ1,1)
end if
