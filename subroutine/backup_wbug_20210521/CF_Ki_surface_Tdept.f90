subroutine CF_Ki_surface_Tdept2(ax,cx,Hex,temp0,Klcr,nr,nunit,irsub,HexT,dK1surf,dK2surf,dK3surf)
implicit none
...
real(8) :: aleng,bleng,cleng,volume,angle,K1til(0:2),K2til(0:2),temp0,K1tilloc(0:2,16),K2tilloc(0:2,16),Klcr(9,nr)
...
do ir=1,16
   ...
   dK01(2,ir,itemp)=K1tilloc(2,ir)-dK01(1,ir,itemp)
   dK02(2,ir,itemp)=(dsqrt(2.0d0)+1.0d0)*(2.0d0*K2tilloc(1,ir)-K2tilloc(0,ir)-K2tilloc(2,ir))
   dK02(1,ir,itemp)=K2tilloc(1,ir)-dK02(2,ir,itemp)/dsqrt(2.0d0)
   dK02(5,ir,itemp)=K2tilloc(0,ir)-dK02(1,ir,itemp)
...
!   Kloc(3,ir,itemp)=K2tilloc(0,ir)-Kloc(2,ir,itemp)
   ...
   Klocave(1,itemp)=Klocave(1,itemp)+dK01(1,ir,itemp) ! K1(1)
   Klocave(2,itemp)=Klocave(2,itemp)+dK02(1,ir,itemp) ! K2(1)
   Klocave(3,itemp)=Klocave(3,itemp)+dK02(5,ir,itemp) ! K2(5)
   Klocave(6,itemp)=Klocave(6,itemp)+dK01(2,ir,itemp) ! K1(2)
   Klocave(7,itemp)=Klocave(7,itemp)+dK02(2,ir,itemp) ! K2(2)
end do
...
end subroutine CF_Ki_surface_Tdept2





subroutine CF_Ki_surface_Tdept(ax,cx,Hex,temp0,Klcr,Klcfe,nr,nfe,nunit,irsub,KuFe,HexT)
implicit none
real(8),parameter :: joule=10.0d0 ! (Merg/J)
