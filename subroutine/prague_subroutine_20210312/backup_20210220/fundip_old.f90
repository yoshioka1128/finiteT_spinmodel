subroutine fundip(dip,TQ,f,ik,Happl,Klc,nunit,nunitx,nunity,nunitz,alphar,gamma,numint0,&
     nr,nrtot,JRR, magR, iIntrr, numintrr, vr,irpt0,irunit,irsub,diprr,&
     nfe,nfetot,JRFe,magFe,iIntrfe,numintrfe,vfe,ifept0,ifeunit,ifesub,diprfe)
implicit none 
...
integer(4) :: irpt0(nr*nunit),ifept0(nr*nunit)
...
!   if(ik.eq.2) then
!      write(6,"(6I5,A,3f15.5)") nr,nfe,i,ix-1,iy,iz,"HA",HA(1),HA(2),HA(3)
!      write(6,"(6I5,A,3f15.5)") nr,nfe,i,ix-1,iy,iz,"Hk",Hk(1),Hk(2),Hk(3)
!   end if
