!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine MF_uniform(nfe,nr,nunit,temp,magFe,magR,JRFe,JFeR,JFeFe,JRR,Hex,Hex0,magR0,magFe0,magRT,magFeT)
implicit none
...
!   write(6,"(I5,3F15.5)") ite,2.0d0*magR1,14.0d0*magFe1,magFe1*14.0d0+magR1*2.0d0
   ...
   write(11,"(F10.3,4F25.17)") temp0,2.0d0*magR1,14.0d0*magFe1,magFe1*14.0d0+magR1*2.0d0,d*(14.0d0*nrf*magFe1)*muB/kb*gr/(gr-1.0d0)/2.0d0
