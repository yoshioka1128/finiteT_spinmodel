!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine dipole(diprfe,nunit,nunitx,nunity,nunitz,ax,cx,nr,rr,nfe,rfe)
implicit none
integer(4) :: nunit,nr,nfe,nunitx,nunity,nunitz
integer(4) :: i,i2,ir,ir2,ife,ife2,ix,iy,iz,ix2,iy2,iz2,ixd,iyd,izd
...
do izd=1-nunitz,nunitz-1
   do iyd=1-nunity,nunity-1
      do ixd=1-nunitx,nunitx-1
         do i2=1,nfe
            do i=1,nr
               drfe(1)=dble(ixd)*ax+rr(i,1)-rfe(i2,1) ! ixd=ir-ife
               drfe(2)=dble(iyd)*ax+rr(i,2)-rfe(i2,2)
               drfe(3)=dble(izd)*cx+rr(i,3)-rfe(i2,3)
