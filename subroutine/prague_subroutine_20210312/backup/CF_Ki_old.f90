...
real(8) :: ax,cx,eng0(4)
real(8) :: J(2),S,Lang,Jzst,Jz,Ost,Ost2,MOst(6,6),abc,stevens(6,2),Blm(6,0:6,4),Blm2(6,0:6),g(2),absj(4),absj0(4)
real(8) :: alpha(2),beta(2),gamma(2),Alm(6,0:6,2),Ecef,Exc,stspin(3)
...
real(8) :: Hex,part(4),temp,free,free0,K2mK3,Dtheta,freetp(0:10000,0:8),freeapp(4),freetploc(0:10000,0:100,4)
...
integer(4) :: m,n,i,k,l,imax,ii,jj,INFO,LWORK,it,ip,itnum=400,ll,mm,ir,inddy,idim(2),itemp,ife
...
!if(rare.eq."Nd") then
! inddy=1
   open(33,file="~/CFPs/cfp"//trim(adjustl(rare))//"opencore_k100.txt")
