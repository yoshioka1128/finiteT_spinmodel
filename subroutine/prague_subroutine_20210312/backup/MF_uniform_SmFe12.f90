!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine MF_uniform_SmFe12(ax,cx,nfe,nr,nunit,temp,magFe,magR,JRFe,JFeR,JFeFe,JRR,Hex,Hex0,magR0,magFe0,magRT,magFeT,HexT)
implicit none
...
real(8) :: temp,temp0,gf=2.0d0,gs=2.0d0,magR(nr*nunit),magFe(nfe*nunit),Hex,d,ax,cx
...
d=4.0d0*1.0d24/(ax**2*cx)*muB ! from f.u. to density (kOe) or (kerg/Oe/cm^3)
...
end subroutine MF_uniform_SmFe12
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
