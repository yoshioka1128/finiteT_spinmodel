subroutine Clm(L1,S1,J0,ZUst,imax,stfct,nJex)
implicit none
...
! Nd
rdcoff=0.0d0
rdcoff(2)=-dsqrt(2.0d0*7.0d0*13.0d0/(3.0d0*11.0d0*15.0d0))
rdcoff(4)=-dsqrt(4.0d0*7.0d0*13.0d0*17.0d0/(3.0d0**2*11.0d0**3))
rdcoff(6)=-50.0d0/11.0d0*dsqrt(17.0d0*19.0d0/(3.0d0**2*11.0d0*13.0d0))
