!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine dipoley(diprfe,nunit,nunitx,nunity,nunitz,ax,cx,nr,rr,nfe,rfe,ncycle)
implicit none
      ...
      do ixd=1-nunitx,nunitx-1
         do i2=1,nfe
            do i=1,nr
               ...
               drfe(1)=dble(ixd)*ax+rr(i,1)-rfe(i2,1)
               drfe(2)=dble(iyd-(2*nunity-1)*ncycle)*ax+rr(i,2)-rfe(i2,2)
