subroutine Tmix_analytical(ir0,sys,method,Tmin,Tmax,dT,SO,HexT0,ratom,Tc)
implicit none
integer(4),parameter :: nrmax=30,itempmax=1000,ianmax=2*10+1
real(8),parameter :: pi=dacos(-1.0d0)
integer(4) :: n4f,itemp,m,n,i,j,k,l,ii,jj,ll,ir,imax,ir0
real(8) :: abc,temp,S1,L1,J1,Hmax,Tmin,Tmax,Tc,dT,Dex0,Dso,JM(100,2),SO(100)
...
do itemp=0,int((Tmax-Tmin)/dT)  ! loop for Temperature 
   ...
   if(temp.eq.0.0d0) then
      do l=1,6
         T0mix1(l)=Tmix1(l)*Dex0/Dso
         T0mix2(l)=Tmix2(l)*Dex0/Dso
      end do
      extBJ0=extBJ
   end if

   write(215,"(6f12.6)") temp,temp/(J1*Dex0),&
        (Tmix1(1)+Tmix2(1))*Dex0/Dso/(T0mix1(1)+T0mix2(1)),&
        (Tmix1(2)+Tmix2(2))*Dex0/Dso/(T0mix1(2)+T0mix2(2)),&
        (Tmix1(4)+Tmix2(4))*Dex0/Dso/(T0mix1(4)+T0mix2(4)),&
        (Tmix1(6)+Tmix2(6))*Dex0/Dso/(T0mix1(6)+T0mix2(6))
   write(220,"(6f12.6)") temp,temp/(J1*Dex0),&
        (Tmix1(1))*Dex0/Dso/(T0mix1(1)),&
        (Tmix1(2))*Dex0/Dso/(T0mix1(2)),&
        (Tmix1(4))*Dex0/Dso/(T0mix1(4)),&
        (Tmix1(6))*Dex0/Dso/(T0mix1(6))
   write(218,"(6f12.6)") temp,temp/(J1*Dex0),&
        (Tmix1(1)+Tmix2(1))*Dex0/Dso/extBJ0(1),&
        (Tmix1(2)+Tmix2(2))*Dex0/Dso/extBJ0(2),&
        (Tmix1(4)+Tmix2(4))*Dex0/Dso/extBJ0(4),&
        (Tmix1(6)+Tmix2(6))*Dex0/Dso/extBJ0(6)
   write(222,"(6f12.6)") temp,temp/(J1*Dex0),&
        (Tmix1(1))*Dex0/Dso/extBJ0(1),&
        (Tmix1(2))*Dex0/Dso/extBJ0(2),&
        (Tmix1(4))*Dex0/Dso/extBJ0(4),&
        (Tmix1(6))*Dex0/Dso/extBJ0(6)
   write(219,"(6f12.6)") temp,temp/(J1*Dex0),&
        (Tmix1(1)+Tmix2(1))*Dex0/Dso,&
        (Tmix1(2)+Tmix2(2))*Dex0/Dso,&
        (Tmix1(4)+Tmix2(4))*Dex0/Dso,&
        (Tmix1(6)+Tmix2(6))*Dex0/Dso
   ...
   write(315,"(6f12.6)") temp,temp/(J1*Dex0),&
        Tmix1(1)*Dex0/Dso/T0mix1(1),Tmix1(2)*Dex0/Dso/T0mix1(2),&
        Tmix1(4)*Dex0/Dso/T0mix1(4),Tmix1(6)*Dex0/Dso/T0mix1(6)
   write(316,"(6f12.6)") temp,temp/(J1*Dex0),&
        Tmix2(1)*Dex0/Dso/T0mix1(1),Tmix2(2)*Dex0/Dso/T0mix1(2),&
        Tmix2(4)*Dex0/Dso/T0mix1(4),Tmix2(6)*Dex0/Dso/T0mix1(6)
   write(317,"(6f12.6)") temp,temp/(J1*Dex0),&
        (Tmix1(1)+Tmix2(1))*Dex0/Dso/T0mix1(1),(Tmix1(2)+Tmix2(2))*Dex0/Dso/T0mix1(2),&
        (Tmix1(4)+Tmix2(4))*Dex0/Dso/T0mix1(4),(Tmix1(6)+Tmix2(6))*Dex0/Dso/T0mix1(6)
end do ! do itemp
